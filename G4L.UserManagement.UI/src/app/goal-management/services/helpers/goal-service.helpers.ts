...
export const transferGoal = (fromList: Array<GoalModel>, toList: Array<GoalModel>, goal: GoalModel): void => {
    // Get backlog index
    const index = fromList.findIndex((goalObj: GoalModel) => goalObj.id === goal.id);
